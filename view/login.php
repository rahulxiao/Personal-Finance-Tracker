    ...
    <div class="main-container">
        ...
        <div class="login-container">
            <div class="login-card">
                ...
                <?php
                // Start session and get errors if they exist
                session_start();
                $errors = $_SESSION['login_errors'] ?? [];
                unset($_SESSION['login_errors']); // Clear errors after displaying
                ?>
                
                <form action="../controller/login.php" method="POST" onsubmit="return validateLogin()" id="login-form" novalidate>
                    <div class="input-group">
                        ...
                        <div class="input-box">
                            ...
                            <?php if (isset($errors['username'])): ?>
                                <span style="color:red; font-size:12px;"><?= $errors['username'] ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="remember-forgot">
                        ...
                        <a href="forget-password.html" class="forgot-link">Forgot password?</a>
                    </div>
